...
# 실행
gen_log "${BLUE}========== 스캔 시작 ==========${NC}"

$run_env && { gen_log "${MAGENTA}[*] 환경 변수 점검 시작${NC}"; check_bpfdoor_env_vars; }
$run_c2 && { gen_log "${MAGENTA}[*] 공격자 IP 점검 시작${NC}"; check_c2_ip_connection; }
